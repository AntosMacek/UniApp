...
public class CosplayDataProvider {
    ...
    private final static String dayOneBlockOneInfo = "" +
            ...
            "23. Shirayuri" + PARTICIPANTS + "Mintaka and Koneko-chan" + CHARACTERS + "Krul and Hyakuya" + FANDOM + "Seraph of the End" + TYPE_DUO +
            ...
            "28. Big Boss from Metal Gear Solid 5" + PARTICIPANTS + "Andosmir" + CHARACTERS + "Snake" + FANDOM + "Metal Gear Solid 5" + SOLO_TYPE +
            "29. Where is Luke?" + PARTICIPANTS + "Elyanna and Alekas" + CHARACTERS + "Luke and Rey" + FANDOM + "Star Wars" + TYPE_DUO;
    ...
    private final static String dayOneBlockTwoInfo = "" +
            ...
            "2. Dragons of Destiny" + PARTICIPANTS + "Dragons of Destiny" + CHARACTERS + "Thor and Loki" + FANDOM + "Avengers" + TYPE_DUO +
    ...
    private final static String dayTwoBlockOneInfo = "" +
            "1. Alpacas Error Duo" + PARTICIPANTS + "Natsumi and Dinarin" + CHARACTERS + "Otohime and Shirahoshi" + FANDOM + "One Piece" + TYPE_DUO +
            "2. Cousins' performance" + PARTICIPANTS + "Gauzera and Luka" + CHARACTERS + "Mettaton and Napstabot" + FANDOM + "Undertale" + DANCE_TYPE +
            "3. Dance of the sword" + PARTICIPANTS + "Visual Aya" + CHARACTERS + "Mikazuki Munechika" + FANDOM + "Touken Ranbu" + SOLO_TYPE +
            "4. The Drill" + PARTICIPANTS + "Zaulinio" + CHARACTERS + "Storm Trooper" + FANDOM + "Star Wars" + DANCE_TYPE +
            "5. Sweet Draculaura" + PARTICIPANTS + "Lilith" + CHARACTERS + "Draculaura" + FANDOM + "Monster High" + SOLO_TYPE +
            "6. Granado Espada" + PARTICIPANTS + "Pandemonnium" + CHARACTERS + "Musketeer, Fighter, Elementalist, Wizard" + FANDOM + "Granado Espada" + GROUP_TYPE +
            "7. The Rise Of Evil Queen" + PARTICIPANTS + "Svajone" + CHARACTERS + "Queen Nehellenia" + FANDOM + "Sailor Moon" + SOLO_TYPE +
            "8. His soul" + PARTICIPANTS + "Insomnia" + CHARACTERS + "Sebastian, Ciel, Alois, Claude" + FANDOM + "Kuroshitsuji" + GROUP_TYPE +
            "9. Arizona as Symmetra from Blizzard’s Overwatch" + PARTICIPANTS + "Arizona" + CHARACTERS + "Symmetra" + FANDOM + "Overwatch" +SOLO_TYPE +
            "10. Duty of the Goddess" + PARTICIPANTS + "Dulcinea" + CHARACTERS + "Freya" + FANDOM + "Smite" +SOLO_TYPE +
            "11. Diva-de-Kara as mew Ichigo and mew Pudding" + PARTICIPANTS + "Diva-de-Kara" + CHARACTERS + "Mew Ichigo and Mew Pudding" + FANDOM + "Tokyo Mew Mew" +TYPE_DUO +
            "12. Secret hobby" + PARTICIPANTS + "Vega" + CHARACTERS + "Genos" + FANDOM + "One-Punch Man" +DANCE_TYPE +
            "13. When you pause a game" + PARTICIPANTS + "City Boyz" + CHARACTERS + "Akashi Kuniyuki, Mitsutada Shokudaikiri, Ookurikara, Uguisumaru" + FANDOM + "Touken Ranbu" +GROUP_TYPE +
            "14. Kira and Ice Sakura as Fushimi and Misaki from K Project" + PARTICIPANTS + "Kira and Ice Sakura" + CHARACTERS + "Fushimi and Misaki" + FANDOM + "K Project" +TYPE_DUO +
            "15. I Am Victorious" + PARTICIPANTS + "Rhaine" + CHARACTERS + "Gaige" + FANDOM + "Borderlands 2" +SOLO_TYPE +
            "16. Thanks for smoking as Food spirits Vanilla and Caramel from  Yumeiro Patissiere" + PARTICIPANTS + "Thanks for Smoking"
            + CHARACTERS + "Vanilla and Caramel" + FANDOM + "Food spirit from Yumeiro Patissiere" +TYPE_DUO +
            "17. Valide Safiye sultan hazretreli" + PARTICIPANTS + "Boltushka" + CHARACTERS + "Safiye Sultan" + FANDOM + "Muhtesem Yuzyil: Kosem" +SOLO_TYPE +
            "18. Empathy. Blazblue. Paranoya as Taokaka and Fury as NU-13" + PARTICIPANTS + "Fury and Paranoya" + CHARACTERS + "Taokaka and NU-13" + FANDOM + "Blazblue" +TYPE_DUO +
            "19. My group let me choose the title so HI MOM" + PARTICIPANTS + "Lin, Little Lady, Little Lord, Dictamnus, Chibi"
            + CHARACTERS + "Yugi Muto, Dark Magician Girl, Bakura Ryou, Change of Heart" + FANDOM + "Yu-Gi-Oh!" +GROUP_TYPE +
            "20. Cinderella's stepsisters -  Anastasia  and Drizella Tremaine!" + PARTICIPANTS + "Thanks for Smoking"
            + CHARACTERS + "Anastasia and Drizella" + FANDOM + "Cinderella" +TYPE_DUO +
            "21. Eternity" + PARTICIPANTS + "Koneko-chan" + CHARACTERS + "CC" + FANDOM + "Code Geass" +DANCE_TYPE +
            "22. Better love story than Twilight" + PARTICIPANTS + "Guren no harem" + CHARACTERS + "Hiiragi Shinya, Hiiragi Mahiru, Ichinose Guren"
            + FANDOM + "Seraph of the End" +GROUP_TYPE +
            "23. CaptainMort as Ciel Phantomhive from Kuroshitsuji" + PARTICIPANTS + "CaptainMort" + CHARACTERS + "Ciel Phantomhive" + FANDOM + "Kuroshitsuji" +SOLO_TYPE +
            "24. Non professional fairies – one reflection" + PARTICIPANTS + "Kai Urusai and Nia" + CHARACTERS + "Peter Pan and Tinker Bell" + FANDOM + "Peter Pan" +TYPE_DUO +
            "25. Angry bun bun with a big shuriken" + PARTICIPANTS + "SHIRO I" + CHARACTERS + "Elin Ninja" + FANDOM + "Tera" +SOLO_TYPE +
            "26. Lady Wolf as Pumpkin Pie from Sakizou Artworks" + PARTICIPANTS + "Lady Wolf" + CHARACTERS + "Pumpkin Pie" + FANDOM + "Sakizou Artworks" +SOLO_TYPE +
            "27. Love, Chunibyo & Other Delusions" + PARTICIPANTS + "Fairy World" + CHARACTERS + "Rikka and Shichimiya" + FANDOM + "Love, Chunibyo & Other Delusions" +TYPE_DUO +
            "28. Sword dance" + PARTICIPANTS + "Shapeshifter" + CHARACTERS + "Shaak-ti" + FANDOM + "Star Wars" +DANCE_TYPE +
            "29. Blackout: Let This World Explode!" + PARTICIPANTS + "Blackout" + CHARACTERS + "Gaige, Tiny Tina, Maya" + FANDOM + "Borderlands" +GROUP_TYPE +
            "";
    ...
    private final static String dayTwoBlockTwoInfo = "" +
            ...
            "2. Nice-kun as Genji from Overwatch" + PARTICIPANTS + "Nice-kun" + CHARACTERS + "Genji" + FANDOM + "Overwatch" +SOLO_TYPE +
            "3. The Third Force rises" + PARTICIPANTS + "Zaulinio" + CHARACTERS + "Storm Trooper" + FANDOM + "Star Wars " +SOLO_TYPE +
            "4. Sword Bois" + PARTICIPANTS + "Visual Aya and Crossmant" + CHARACTERS + "Mikazuki Munechika and Kogitsunemaru" + FANDOM + "Touken Ranbu" +TYPE_DUO +
            "5. Dragons of Destiny as Sally from Nightmare before Christmas" + PARTICIPANTS + "Scarlett Lily" + CHARACTERS + "Sally" + FANDOM + "Nightmare Before Christmas" +SOLO_TYPE +
            "6. For your entertainment!" + PARTICIPANTS + "Insomnia" + CHARACTERS + "Ciel and Alois" + FANDOM + "Kuroshitsuji" +DANCE_TYPE +
            "7. Touken Dream come true" + PARTICIPANTS + "Black&White" + CHARACTERS + "Akashi Kuniyuki, Tsurumaru Kuninaga, Mikazuki Munechika" + FANDOM + "Touken Ranbu" +GROUP_TYPE +
            "8. Spinoza" + PARTICIPANTS + "John and Kato" + CHARACTERS + "Astrid and Stormfly" + FANDOM + "How to Train your Dragon" +TYPE_DUO +
            "9. Keep calm and Junkrat on!" + PARTICIPANTS + "Hooots_Senpai" + CHARACTERS + "Junkrat" + FANDOM + "Overwatch" +SOLO_TYPE +
            "10. Once Upon a Time on Pandora" + PARTICIPANTS + "Narya" + CHARACTERS + "Maya" + FANDOM + "Borderlands 2" +SOLO_TYPE +
            "11. Owari no Seraph" + PARTICIPANTS + "Sanahi" + CHARACTERS + "Shinya Hiiragi" + FANDOM + "Seraph of the End" +SOLO_TYPE +
            "12. Once in Moving Castle" + PARTICIPANTS + "Kiom and Drebedenik" + CHARACTERS + "Howl and Sophie" + FANDOM + "Howl's Moving Castle" +TYPE_DUO +
            "13. Join us, Join the Rooks!" + PARTICIPANTS + "SkyRocker, Coraline, Templars" + CHARACTERS + "Jacob Frye, Evie Frye, Templars" + FANDOM + "Assassins Creed" +GROUP_TYPE +
            "14. Aion" + PARTICIPANTS + "HELL" + CHARACTERS + "Aion Sorcerer" + FANDOM + "Aion" +SOLO_TYPE +
            "15. From shadows to the bright sun" + PARTICIPANTS + "T-oku and Wolfsgirl" + CHARACTERS + "Minato and Kushina" + FANDOM + "Naruto" +TYPE_DUO +
            "16. TROUBLE MAKER- NOW" + PARTICIPANTS + "Miyabi and Ivo" + CHARACTERS + "Hyuna and HyunSeung" + FANDOM + "K-pop" +DANCE_TYPE +
            "17. Heroes of Honor as Mercy, Hanzo and Symmetra from Blizzard’s Overwatch" + PARTICIPANTS + "Heroes of Honor"
            + CHARACTERS + "Mercy, Hanzo, Symmetra" + FANDOM + "Overwatch" +GROUP_TYPE +
            "18. Cillit Butler!" + PARTICIPANTS + "Insomnia" + CHARACTERS + "Sebastian and Claude" + FANDOM + "Kuroshitsuji" +DANCE_TYPE +
            "19. Blood is all for a vampire!" + PARTICIPANTS + "Anika" + CHARACTERS + "Krul Tepes" + FANDOM + "Seraph of the End" +SOLO_TYPE +
            "20. I am the blade in the shadow" + PARTICIPANTS + "White Flame" + CHARACTERS + "Shao Jun" + FANDOM + "Assasins Creed China Chronicles" +SOLO_TYPE +
            "21. Dragons of Destiny as Alice the Bloody Rabbit and Will of the Abyss from Pandora Hearts" + PARTICIPANTS + "Dragons of Destiny" + CHARACTERS
            + "Alice the Bloody Rabbit and Will of the Abyss" + FANDOM + "Pandora Hearts" +TYPE_DUO +
            "22. Excuse me!" + PARTICIPANTS + "Vikonija" + CHARACTERS + "Roberta" + FANDOM + "Black Lagoon" +SOLO_TYPE +
            "23. Stormfly the dragon" + PARTICIPANTS + "John" + CHARACTERS + "Stormfly" + FANDOM + "How to Train your Dragon" +SOLO_TYPE +
            "25. 404 not found" + PARTICIPANTS + "Kaori and Margosha" + CHARACTERS + "Gaige and Handsome Jack" + FANDOM + "Borderlands 2" +TYPE_DUO +
            "24. Le Petit Prince" + PARTICIPANTS + "Cat Bounce" + CHARACTERS + "Little Prince" + FANDOM + "Little Prince" +SOLO_TYPE +
            "26. Hathor from  Gods of Egypt" + PARTICIPANTS + "Nashiro" + CHARACTERS + "Hathor" + FANDOM + "Gods of Egypt" +SOLO_TYPE +
            "27. JoJo's Bizarre Adventure Part 4: Diamond Is Unbreakable" + PARTICIPANTS + "BLAST" + CHARACTERS
            + "Josuke and Okuyasu" + FANDOM + "JoJo's Bizarre Adventure Part 4: Diamond Is Unbreakable" +TYPE_DUO +
            "28. Shokugeki no Soma" + PARTICIPANTS + "Flafstar and MadMaid" + CHARACTERS + "Soma and fem!Soma" + FANDOM + "Shokugeki no Soma" +DANCE_TYPE +
            "29. Insomnia" + PARTICIPANTS + "True Baba" + CHARACTERS + "Rocket" + FANDOM + "Sucker Punch" +SOLO_TYPE +
            "30. The Saber Dance" + PARTICIPANTS + "Lasura" + CHARACTERS + "Sith Marauder OC" + FANDOM + "Star Wars" +SOLO_TYPE +
            "";
