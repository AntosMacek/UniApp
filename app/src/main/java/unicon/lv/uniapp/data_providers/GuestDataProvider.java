...
public class GuestDataProvider {
    ...
    public static LinkedHashMap<String, List<String>> getInfo() {
        ...
        //guest3
        guest3.add(CATEGORY_COSPLAYER);
        guest3.add(COUNTRY + "Finland");
        guest3.add("Elffi is a Finnish cosplayer who lives in the middle of the Finnish forest with his tortoise, Kippe.\n" +
                "\n" +
        ...
        //guest4
        guest4.add(CATEGORY_COSPLAYER);
        guest4.add(COUNTRY + "Germany");
        guest4.add("\"I live in Munich and in my real life I work as a Silversmith.\n" +
                "\n" +
        ...
        //guest5
        guest5.add("Category: Photographer");
        guest5.add(COUNTRY + "Belgium");
        guest5.add("I’m from Belgium and started taking photos about 10 years ago when i bought my first DSLR camera. At first I only took the pictures everyone takes with their phone these days, but after a while I noticed that I prefered taking pictures of people. One day a colleague at work told me about ‘conventions’ and there it all started. \n" +
                "\n" +
